    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fazerLogin();
                if(fazerLogin() == true){
                    startActivity(new Intent(com.example.garage.Activity.LoginActivity.this, TelaPrincipal.class));
                    finish();
                }
            }
        });
        ...
        btn_cadastrar_usuario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(com.example.garage.Activity.LoginActivity.this, CadastroUsuario.class));
                finish();
            }
        });
    }
